...
# Brian Blaylock
# March 13, 2021
# Standardized colormaps from National Weather Service and more
# https://github.com/blaylockbk/Carpenter_Workshop/tree/main/paint
...
class cm_snow:
    def __init__(self, vmin=0, vmax=42, levels="default", units="mm"):
        assert units in ["mm", "in"], 'units must be "mm" or "in"'
        self.levels = levels
        self.vmin = vmin
        self.vmax = vmax
        ...
        # These are in mm
        self.bounds = np.array([0, 0.05, 0.5, 1, 1.5, 2, 3, 4, 6, 9, 12, 15, 18])
